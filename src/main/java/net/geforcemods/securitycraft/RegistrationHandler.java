...
public class RegistrationHandler
{
	...
	public static void registerContent()
	{
		...
		GameRegistry.registerBlock(SCContent.deactivatedCageTrap, SCContent.deactivatedCageTrap.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		...
		GameRegistry.registerBlock(SCContent.claymoreDefused, SCContent.claymoreDefused.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		registerBlock(SCContent.keypadFurnace);
		registerBlock(SCContent.securityCamera);
		GameRegistry.registerBlock(SCContent.reinforcedStairsOak, SCContent.reinforcedStairsOak.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		GameRegistry.registerBlock(SCContent.reinforcedStairsSpruce, SCContent.reinforcedStairsSpruce.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		GameRegistry.registerBlock(SCContent.reinforcedStairsBirch, SCContent.reinforcedStairsBirch.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		GameRegistry.registerBlock(SCContent.reinforcedStairsJungle, SCContent.reinforcedStairsJungle.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		GameRegistry.registerBlock(SCContent.reinforcedStairsAcacia, SCContent.reinforcedStairsAcacia.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		GameRegistry.registerBlock(SCContent.reinforcedStairsDarkoak, SCContent.reinforcedStairsDarkoak.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		...
		GameRegistry.registerBlock(SCContent.reinforcedDirtSlab, ItemBlockReinforcedSlabs.class, SCContent.reinforcedDirtSlab.getUnlocalizedName().substring(5).replace("securitycraft:", ""), SCContent.reinforcedDirtSlab, false, ItemBlockReinforcedSlabs.ReinforcedSlabType.OTHER);
		GameRegistry.registerBlock(SCContent.reinforcedDoubleWoodSlabs, SCContent.reinforcedDoubleWoodSlabs.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		GameRegistry.registerBlock(SCContent.reinforcedDoubleStoneSlabs, SCContent.reinforcedDoubleStoneSlabs.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
		GameRegistry.registerBlock(SCContent.reinforcedDoubleDirtSlab, SCContent.reinforcedDoubleDirtSlab.getUnlocalizedName().substring(5).replace("securitycraft:", ""));
	...
	//	network.registerMessage(PacketSetBlock.Handler.class, PacketSetBlock.class, 1, Side.SERVER);
		...
		network.registerMessage(PacketSetISType.Handler.class, PacketSetISType.class, 1, Side.SERVER);
		network.registerMessage(PacketSetKeycardLevel.Handler.class, PacketSetKeycardLevel.class, 2, Side.SERVER);
		network.registerMessage(PacketUpdateLogger.Handler.class, PacketUpdateLogger.class, 3, Side.CLIENT);
		network.registerMessage(PacketCUpdateNBTTag.Handler.class, PacketCUpdateNBTTag.class, 4, Side.CLIENT);
		network.registerMessage(PacketSUpdateNBTTag.Handler.class, PacketSUpdateNBTTag.class, 5, Side.SERVER);
		network.registerMessage(PacketCPlaySoundAtPos.Handler.class, PacketCPlaySoundAtPos.class, 6, Side.CLIENT);
		network.registerMessage(PacketSetExplosiveState.Handler.class, PacketSetExplosiveState.class, 7, Side.SERVER);
		network.registerMessage(PacketGivePotionEffect.Handler.class, PacketGivePotionEffect.class, 8, Side.SERVER);
		// todo fix packet exploiting
	//	network.registerMessage(PacketSetBlockAndMetadata.Handler.class, PacketSetBlockAndMetadata.class, 11, Side.SERVER);
		network.registerMessage(PacketSSetOwner.Handler.class, PacketSSetOwner.class, 9, Side.SERVER);
		network.registerMessage(PacketSAddModules.Handler.class, PacketSAddModules.class, 10, Side.SERVER);
		network.registerMessage(PacketCSetCameraLocation.Handler.class, PacketCSetCameraLocation.class, 11, Side.CLIENT);
		network.registerMessage(PacketCRemoveLGView.Handler.class, PacketCRemoveLGView.class, 12, Side.CLIENT);
		network.registerMessage(PacketCCreateLGView.Handler.class, PacketCCreateLGView.class, 13, Side.CLIENT);
		...
		network.registerMessage(PacketSMountCamera.Handler.class, PacketSMountCamera.class, 17, Side.SERVER);
		network.registerMessage(PacketSSetCameraRotation.Handler.class, PacketSSetCameraRotation.class, 18, Side.SERVER);
		network.registerMessage(PacketCSetPlayerPositionAndRotation.Handler.class, PacketCSetPlayerPositionAndRotation.class, 19, Side.CLIENT);
		network.registerMessage(PacketCSpawnLightning.Handler.class, PacketCSpawnLightning.class, 20, Side.CLIENT);
		network.registerMessage(PacketSOpenGui.Handler.class, PacketSOpenGui.class, 21, Side.SERVER);
		network.registerMessage(PacketSToggleOption.Handler.class, PacketSToggleOption.class, 22, Side.SERVER);
		network.registerMessage(PacketSUpdateSliderValue.Handler.class, PacketSUpdateSliderValue.class, 23, Side.SERVER);
		network.registerMessage(PacketSRemoveCameraTag.Handler.class, PacketSRemoveCameraTag.class, 24, Side.SERVER);
		network.registerMessage(PacketCChangeStackSize.Handler.class, PacketCChangeStackSize.class, 25, Side.CLIENT);
		network.registerMessage(PacketCInitSentryAnimation.Handler.class, PacketCInitSentryAnimation.class, 26, Side.CLIENT);
		network.registerMessage(PacketCToggleBlockPocketManager.Handler.class, PacketCToggleBlockPocketManager.class, 27, Side.SERVER);
		network.registerMessage(PacketCClearLogger.Handler.class, PacketCClearLogger.class, 28, Side.CLIENT);
		network.registerMessage(PacketSClearLogger.Handler.class, PacketSClearLogger.class, 29, Side.SERVER);
	}
